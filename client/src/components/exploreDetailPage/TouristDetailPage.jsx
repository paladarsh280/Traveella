      ...
      <div className="w-full max-w-7xl flex gap-10">
        ...
        <div className="w-2/3">
          ...
          <div className="flex gap-3 mb-4">
            <span className="px-4 py-1 text-sm bg-gray-100 rounded-full">Bestseller</span>
            <span className="px-4 py-1 text-sm bg-gray-100 rounded-full">Free cancellation</span>
          </div>
          ...
          <div className="flex gap-6 mb-10">
            <div className="w-32 h-20 border rounded-2xl flex flex-col justify-center pl-4 text-sm">
            ...
            <div className="w-32 h-20 border rounded-2xl flex flex-col justify-center pl-4 text-sm">
              ...
              <span className="font-medium">18–99 yrs</span>
            </div>

            <div className="w-40 h-20 border rounded-2xl flex flex-col justify-center pl-4 text-sm">
              <span className="text-gray-500">Languages</span>
              <span className="font-medium">English, Japanese</span>
            </div>
          </div>

          {/* Tour Overview */}
          <h2 className="text-xl font-bold mb-3">Tour Overview</h2>
          <p className="text-sm leading-relaxed text-gray-700 mb-8 max-w-2xl">
        ...
        <div className="w-1/3">
          <div className="border rounded-2xl p-6 shadow-sm sticky top-10">
            ...
            <p className="text-2xl font-semibold mb-4">$1,200</p>

            {/* Date and Time */}
            <div className="border rounded-xl overflow-hidden mb-6">
              <div className="p-4 border-b">
                <p className="text-xs text-gray-500">From</p>
                <p className="text-sm">February 05 ~ March 14</p>
              </div>
            ...
            {/* Add Extra */}
            <h3 className="font-medium mb-3">Add Extra</h3>
            <div className="space-y-3 text-sm mb-6">
              ...
              <div className="flex justify-between items-center">
                <p>Add Service per person<br /><span className="text-xs">Adult: $17 • Youth: $14</span></p>
                <span>$40</span>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center border-t pt-4 mb-6">
              ...
              <p className="font-semibold text-lg">$530.00</p>
            </div>
