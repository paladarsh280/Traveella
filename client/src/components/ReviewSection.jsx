...
//         {
//             overview: "GreatWork",
//             reviewText: "“I think Educrat is the best theme I ever seen this yea. Amazing design, easy to customize and a design quality superlative account on its cloud platform for the optimized performance”",
//             imgSrc: "../images/review1.png",
//             name: "Alex Morgan"
//         }
//     ];
    
//     // NOTE: I combined your separate arrays into a single, clean Array of Objects (reviewsData)
//     // This is the standard, much cleaner way to handle related data in React.

//     return (
//         <div className="review-section-container">
//             <h2>Customer Reviews ({reviewsData.length})</h2>
            
//             <div className="reviews-grid">
//                 {reviewsData.map((review, index) => (
//                     // Always use a 'key' when mapping in React for performance!
//                     <div key={index} className="review-card">
                        
//                         {/* Display the overview (e.g., rating or title) */}
//                         <h3 className="review-overview">{review.overview}</h3>
                        
//                         {/* The main review text */}
//                         <p className="review-text">{review.reviewText}</p>
                        
//                         <div className="reviewer-info">
//                             {/* NOTE: You'll need to ensure these image paths are correct relative to where your code runs */}
//                             <img src={review.imgSrc} alt={review.name} className="reviewer-img" style={{width: '50px', height: '50px'}}/>
